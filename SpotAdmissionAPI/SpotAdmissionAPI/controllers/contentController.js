...
exports.deleteContent = asyncHandlerContent(async (req, res) => { const b = await Content.findById(req.params.id); if (!b) { res.status(404); throw new Error('Content not found'); } await b.deleteOne(); res.json({ message: 'Content removed' }); });