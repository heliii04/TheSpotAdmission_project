...
const PersonalizedCounselingForm: React.FC = () => {
  ...
  const requiredFields = ["fullName", "email", "contact", "gender", "expectations"];
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-12">
          ...
          <section className="bg-indigo-50/50 -mx-8 p-8 border-y border-indigo-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols- gap-6">
              <label className={labelStyle}>Expectations from Counselling</label><input name="expectation" className={getInputClass("expectations")} onChange={handleChange} />
            </div>
          </section>
