          ...
          <form onSubmit={handleSubmit} className="space-y-12 relative z-10" noValidate>
            ...
            <div className="p-12 md:p-24 text-center animate-in fade-in zoom-in duration-500">
              ...
              <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
                ...
                <button onClick={() => { setIsSubmitted(false); setFormData(requiredFields); }} className="flex items-center gap-2 px-10 py-4 bg-indigo-50 text-indigo-600 font-black rounded-2xl hover:bg-indigo-100 border border-indigo-100">
